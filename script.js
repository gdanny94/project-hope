...
const client_id = "AZWxXpasn_kSYO-k5FzkBI6mpsR5j1kjH1hh0oVANmYEtqkfMNPWENygpJHI_SrCiKQdP55TCE3io10j";
const currency = "USD";
        ...
        return fetch("http://localhost:3000/complete_order", {
          ...
          .then((order_details) => {
            ...
            alerts.innerHTML =
              ...
              order_details.purchase_units[0].payments[intent_object][0].amount
                .currency_code +
              `! Pruébenme en esto —dice el Señor de los Ejércitos—, y vean si no abro las compuertas del cielo y derramo sobre ustedes bendición hasta que sobreabunde. - Malaquías 3:10</div>`;
